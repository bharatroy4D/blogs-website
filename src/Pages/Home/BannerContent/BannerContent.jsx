        ...
        <div className="flex flex-col gap-12 py-5">
            ...
            <div className="relative flex flex-col md:flex-row gap-4 rounded-xl shadow p-2">
                <img
                    ...
                    alt="Man"
                    loading="lazy"
                    className="w-full md:w-60 h-44 rounded object-cover bg-gray-100"
                />

                <div className="flex flex-col gap-3">
                    <button className="text-sm text-white font-bold w-fit py-1 px-3 rounded bg-green-400">
                        Travel
                    </button>
            ...
            <div className="relative flex flex-col md:flex-row gap-4 rounded-xl shadow-md p-2">
                ...
                <div className="flex flex-col gap-3">
                    <button className="text-sm text-white font-bold w-fit py-1 px-3 rounded bg-pink-400">
                        Lifestyle
                    </button>
                    <h1 className="text-lg md:text-xl font-bold">
                        Winter Dressing Tips When It's Really Cold Out
